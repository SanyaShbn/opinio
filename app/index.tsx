...
const logo = require('./settings/images/organization-logo-icon.png');
export default function Index() {
  return (
    <NativeBaseProvider>
      <Center flex={1}>
        {/* <Profile title="Название организации" logo={logo} discussions={10} surveys={10} followers={10}
         description="Описание организации" buttonText="Подписаться"/> */}

         {/* <Post logo={logo} title="Название организации" subtitle="10 дней назад"
...
"
         ...
         comments={10} onReadMore={() => console.log("Read more clicked")} type="default"/> */}

         <PollsCard logo={logo} type="variant3" orgName="Название организации" topic="Медицина" text="Заголовок опроса" date="28.10.2024" votesNumb={100} questionsNumb={10}/>
      </Center>
    </NativeBaseProvider>
  );
}