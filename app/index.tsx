  ...
  return (
    <NativeBaseProvider>
      <Center flex={1}>
        ...
        {/* <Profile title="Название организации" discussions={10} surveys={10} followers={10}
         description="Описание организации" buttonText="Подписаться"/> */}

         {/* <OrganizationCard topic = "Медицина" text = "Название организации" surveysNumb = {10} topicsNumb = {20}/> */}

         {/* <Post title="Название организации" subtitle="10 дней назад"
