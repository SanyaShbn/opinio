    ...
    organizations:[

        {
            ...
            bonuses: [
               {
                    id: "smdmciosc79a", 
                    name: "Название бонусы",
                    description: "Описание бонуса", 
                    createdAt: "2024-11-26T10:34:00", 
                    updatedAt: "2024-11-26T10:34:00" 
                }
            ],
            polls: [
...
//  //---sign up organization---
//  export const fetchPolls = apiFactory.createGetRequest(api.user.signUpOrg)
//  //----------------------
...
export function getPolls(state) {
  if (state[DomainNames.user].type == statusTypes.user) {
    return state[DomainNames.user].user.polls;
  } else if (state[DomainNames.user].type === statusTypes.org) {
    return state[DomainNames.user].organization.polls;
  }
}
